...
RSpec.describe "/image_posts", type: :request do
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new ImagePost" do
        expect {
          post image_posts_url, params: { image_post: valid_attributes }
        }.to change(ImagePost, :count).by(1)
      end

      it "redirects to the created image_post" do
        post image_posts_url, params: { image_post: valid_attributes }
        expect(response).to redirect_to(image_post_url(ImagePost.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new ImagePost" do
        expect {
          post image_posts_url, params: { image_post: invalid_attributes }
        }.to change(ImagePost, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested image_post" do
        image_post = ImagePost.create! valid_attributes
        patch image_post_url(image_post), params: { image_post: new_attributes }
        image_post.reload
      ...
      it "redirects to the image_post" do
        ...
        patch image_post_url(image_post), params: { image_post: new_attributes }
        image_post.reload
        expect(response).to redirect_to(image_post_url(image_post))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        image_post = ImagePost.create! valid_attributes
        patch image_post_url(image_post), params: { image_post: invalid_attributes }
        expect(response).to be_successful
      end
    end
  end
